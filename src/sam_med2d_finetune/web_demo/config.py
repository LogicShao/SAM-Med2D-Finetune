...
# Web demo code lives in src/, while datasets, checkpoints, and outputs stay at
# the repository root. Keep these roots explicit so later agents do not infer
# runtime paths from the package location.
PACKAGE_WEB_DEMO_ROOT = Path(__file__).resolve().parent
PROJECT_ROOT = Path(__file__).resolve().parents[3]
WEB_DEMO_ROOT = PACKAGE_WEB_DEMO_ROOT
