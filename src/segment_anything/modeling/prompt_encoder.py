...
class PromptEncoder(nn.Module):
    ...
    def _embed_points(
        ...
        self.not_a_point_embed.weight = torch.nn.Parameter(self.not_a_point_embed.weight.to(point_embedding.dtype),
                                                           requires_grad=True)  # todo
        self.point_embeddings[0].weight = torch.nn.Parameter(self.point_embeddings[0].weight.to(point_embedding.dtype),
                                                             requires_grad=True)  # todo
        self.point_embeddings[1].weight = torch.nn.Parameter(self.point_embeddings[1].weight.to(point_embedding.dtype),
                                                             requires_grad=True)  # todo
